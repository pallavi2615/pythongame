...
# Welcome Image
bimg = pygame.image.load("Snake2.jpg")
...
# Game Title
pygame.display.set_caption("Snake By Pallavi")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to Snakes", purple, 300, 250)
        text_screen("Press Space Bar To Play", purple, 260, 300)
        text_screen("Design By Pallavi Mishra", purple, 260, 360)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Game Over! Press Enter To Restart The Game", purple, 50,50)
            ...
            text_screen("Score: "+ str(score) + " Highscore: "+ str(highscore), fuchsia, 5, 5)
            ...
            if head in snk_list[:-1]:
                game_over = True
                pygame.mixer.music.load('Game Over Sms.mp3')
                pygame.mixer.music.play()
